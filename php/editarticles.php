...
if (isset($_GET['id'])) {
    $delete = mysqli_query($connect, "DELETE FROM `articles` WHERE `id` = '$article_id'");
    header('Location: ../php/editarticles.php');
}
    ...
    <div id="content" class="content">
        ...
        <div class="main">
            ...
            <a href="/php/adminpanel.php">
                <div style="z-index:20" class="goback">
                    <p>Назад</p>
                </div>
            </a>
            ...
            <div class="mainprogs">
                ...
                <form action="/code/addarticle.php" method="post" enctype="multipart/form-data"><br>
                    <input name="name" type="text" placeholder="Заголовок статьи"><br>
                    <textarea name="text" id="" cols="30" rows="10" placeholder="Текст статьи"></textarea><br>
                ...
                <div class="progsetka">
                    ...
                    $items = mysqli_query($connect, "SELECT * FROM `articles`");
                    $items = mysqli_fetch_all($items);

                    foreach ($items as $item) {
                        echo '<a href="editarticles.php?id=' . $item[0] . '">
                                <div class="statsetkaitem del">
            ...
            <!-- <div class="mainprogs">
                ...
                <div class="gamesetka">
                    ...
                    <div class="statsetkaitem">

                        <p class="date">28.01.2023</p>

                        <h4>Как работает VPN proxi и как это использвать</h4>
                        <p>WARP - бесплатный VPN для перенаправления интернет-соединения через DNS-сервера Cloudflare,
                            что делает...</p>

                        <div class="back">
                            <div class="black">
                            </div>
                            <img src="https://roskomsvoboda.org/uploads/images/VPN_popularity.jpg" alt="">
                        </div>
