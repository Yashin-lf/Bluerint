...
<body>
    ...
    <div id="content" class="content">
        ...
        <div class="main">
            ...
            $progschart = mysqli_query($connect, "SELECT * FROM `programs` WHERE `category` = 2 ORDER BY `programs`.`rating` DESC LIMIT 5");
            $progschart = mysqli_fetch_all($progschart);

            $gameschart = mysqli_query($connect, "SELECT * FROM `programs` WHERE `category` = 1 ORDER BY `programs`.`rating` DESC LIMIT 5");
            $gameschart = mysqli_fetch_all($gameschart);


            $countusers = mysqli_query($connect, "SELECT COUNT(1) FROM `accounts`");
            $num_users = mysqli_fetch_row($countusers)[0];


            $countprogs = mysqli_query($connect, "SELECT COUNT(1) FROM `programs` WHERE `category` = 2");
            $num_progs = mysqli_fetch_row($countprogs)[0];

            $countgames = mysqli_query($connect, "SELECT COUNT(1) FROM `programs` WHERE `category` = 1");
            $num_games = mysqli_fetch_row($countgames)[0];


            $countcomments = mysqli_query($connect, "SELECT COUNT(1) FROM `comments`");
            $num_comments = mysqli_fetch_row($countcomments)[0];
            ...
            <div class="ratingcont">
                ...
                <div class="rating">
                    ...
                    <p>Рейтинг приложений</p>

                    <?php

                    foreach ($progschart as $prog) {
                        echo '<div class="ratinfo">
                        ...
                        <div class="downlds">
                            ...
                            <path d="M14.0007 9.3335C13.8238 9.3335 13.6543 9.40373 13.5292 9.52876C13.4042 9.65378 13.334 9.82335 13.334 10.0002V12.6668C13.334 12.8436 13.2637 13.0132 13.1387 13.1382C13.0137 13.2633 12.8441 13.3335 12.6673 13.3335H3.33398C3.15717 13.3335 2.9876 13.2633 2.86258 13.1382C2.73756 13.0132 2.66732 12.8436 2.66732 12.6668V10.0002C2.66732 9.82335 2.59708 9.65378 2.47206 9.52876C2.34703 9.40373 2.17746 9.3335 2.00065 9.3335C1.82384 9.3335 1.65427 9.40373 1.52925 9.52876C1.40422 9.65378 1.33398 9.82335 1.33398 10.0002V12.6668C1.33398 13.1973 1.5447 13.706 1.91977 14.081C2.29484 14.4561 2.80355 14.6668 3.33398 14.6668H12.6673C13.1978 14.6668 13.7065 14.4561 14.0815 14.081C14.4566 13.706 14.6673 13.1973 14.6673 12.6668V10.0002C14.6673 9.82335 14.5971 9.65378 14.4721 9.52876C14.347 9.40373 14.1775 9.3335 14.0007 9.3335ZM7.52732 10.4735C7.59072 10.5342 7.66548 10.5818 7.74732 10.6135C7.82712 10.6488 7.9134 10.667 8.00065 10.667C8.0879 10.667 8.17418 10.6488 8.25398 10.6135C8.33582 10.5818 8.41058 10.5342 8.47398 10.4735L11.1407 7.80683C11.2662 7.68129 11.3367 7.51103 11.3367 7.3335C11.3367 7.15596 11.2662 6.9857 11.1407 6.86016C11.0151 6.73463 10.8449 6.6641 10.6673 6.6641C10.4898 6.6641 10.3195 6.73463 10.194 6.86016L8.66732 8.3935V2.00016C8.66732 1.82335 8.59708 1.65378 8.47206 1.52876C8.34703 1.40373 8.17746 1.3335 8.00065 1.3335C7.82384 1.3335 7.65427 1.40373 7.52925 1.52876C7.40422 1.65378 7.33398 1.82335 7.33398 2.00016V8.3935L5.80732 6.86016C5.74516 6.798 5.67137 6.7487 5.59015 6.71506C5.50894 6.68142 5.42189 6.6641 5.33398 6.6641C5.24608 6.6641 5.15903 6.68142 5.07782 6.71506C4.9966 6.7487 4.92281 6.798 4.86065 6.86016C4.79849 6.92232 4.74919 6.99612 4.71554 7.07733C4.6819 7.15854 4.66459 7.24559 4.66459 7.3335C4.66459 7.4214 4.6819 7.50845 4.71554 7.58966C4.74919 7.67088 4.79849 7.74467 4.86065 7.80683L7.52732 10.4735Z" fill="#666666" stroke="#666666" stroke-width="0.3"/>
                            </svg>
                        </div>
            ...
            <a href="/php/contentmanager.php">
                <div class="adminlink">
                    ...
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M12.7092 11.9998L9.1692 15.5398C8.98295 15.7272 8.87841 15.9806 8.87841 16.2448C8.87841 16.509 8.98295 16.7624 9.1692 16.9498C9.26217 17.0435 9.37277 17.1179 9.49463 17.1687C9.61648 17.2195 9.74719 17.2456 9.8792 17.2456C10.0112 17.2456 10.1419 17.2195 10.2638 17.1687C10.3856 17.1179 10.4962 17.0435 10.5892 16.9498L14.8292 12.7098C14.9229 12.6168 14.9973 12.5062 15.0481 12.3844C15.0989 12.2625 15.125 12.1318 15.125 11.9998C15.125 11.8678 15.0989 11.7371 15.0481 11.6152C14.9973 11.4934 14.9229 11.3828 14.8292 11.2898L10.5892 6.99981C10.4958 6.90713 10.3849 6.8338 10.2631 6.78404C10.1413 6.73427 10.0108 6.70904 9.8792 6.70981C9.7476 6.70904 9.61713 6.73427 9.4953 6.78404C9.37346 6.8338 9.26264 6.90713 9.1692 6.99981C8.98295 7.18717 8.87841 7.44062 8.87841 7.70481C8.87841 7.96899 8.98295 8.22244 9.1692 8.40981L12.7092 11.9998Z" fill="#2C2C2C"/>
                    </svg>
                </div>
            </a>

            <a href="/php/users.php">
                <div class="adminlink">
                    <h3>Просмотр базы пользователей</h3>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M12.7092 11.9998L9.1692 15.5398C8.98295 15.7272 8.87841 15.9806 8.87841 16.2448C8.87841 16.509 8.98295 16.7624 9.1692 16.9498C9.26217 17.0435 9.37277 17.1179 9.49463 17.1687C9.61648 17.2195 9.74719 17.2456 9.8792 17.2456C10.0112 17.2456 10.1419 17.2195 10.2638 17.1687C10.3856 17.1179 10.4962 17.0435 10.5892 16.9498L14.8292 12.7098C14.9229 12.6168 14.9973 12.5062 15.0481 12.3844C15.0989 12.2625 15.125 12.1318 15.125 11.9998C15.125 11.8678 15.0989 11.7371 15.0481 11.6152C14.9973 11.4934 14.9229 11.3828 14.8292 11.2898L10.5892 6.99981C10.4958 6.90713 10.3849 6.8338 10.2631 6.78404C10.1413 6.73427 10.0108 6.70904 9.8792 6.70981C9.7476 6.70904 9.61713 6.73427 9.4953 6.78404C9.37346 6.8338 9.26264 6.90713 9.1692 6.99981C8.98295 7.18717 8.87841 7.44062 8.87841 7.70481C8.87841 7.96899 8.98295 8.22244 9.1692 8.40981L12.7092 11.9998Z" fill="#2C2C2C"/>
                    </svg>
                </div>
