            ...
            <div class="menu">
                ...
                <a class="nolink" href="/php/programs.php">
                    <div style="background: #F24747; box-shadow: 0px 0px 20px 5px rgba(0, 0, 0, 0.199);" class="mbtn">
                        ...
                        <p style="color: white">Программы</p>
        ...
        <div class="main">
            ...
            <div class="mainprogs">
                ...
                <div class="progsetka">
                    ...
                    $items = mysqli_query($connect, "SELECT * FROM `programs` WHERE `category` = '2' ORDER BY `programs`.`rating` DESC");
                    $items = mysqli_fetch_all($items);

                    foreach ($items as $item) {
                        echo '<a href="/php/itempage.php?id=' . $item[0] . '">
                        <div class="progsetkaitem">
