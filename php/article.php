...
<body>
    ...
    <div id="content" class="content">
        ...
        <div class="main">
            ...
            $article = mysqli_query($connect, "SELECT * FROM `articles` WHERE `id` = '$id'");
            $article = mysqli_fetch_all($article);
            ...
            <div class="mainprogs">
                ...
                <p style="padding-top:40px; width:480px"><?php echo nl2br($article[0][2])?></p>
