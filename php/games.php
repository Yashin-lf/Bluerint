        ...
        <div class="main">
            ...
            <div class="mainprogs">
                ...
                <div class="progsetka">
                    ...
                    $items = mysqli_query($connect, "SELECT * FROM `programs` WHERE `category` = '1' ORDER BY `programs`.`rating` DESC");
                    $items = mysqli_fetch_all($items);

                    foreach ($items as $item) {
                        echo '<a href="itempage.php?id=' . $item[0] . '">
                        <div class="gamesetkaitem">
