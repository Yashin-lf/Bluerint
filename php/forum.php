...
<head>
    ...
    <link rel="stylesheet" href="php/forum_answer.php">
...
<body>
    ...
    <div id="content" class="content">
        ...
        <div class="main">
            ...
            $forum = $connect->query("SELECT * FROM `forum` ORDER BY `forum`.`id` DESC");
            $forumdisplay = mysqli_fetch_all($forum);
            ...
            foreach ($forumdisplay as $display) {

                $requestavatar = mysqli_query($connect, "SELECT `avatar` FROM `accounts` WHERE `id`= '$display[1]'");
                $requestavatar = mysqli_fetch_all($requestavatar);
                $answers = mysqli_query($connect, "SELECT * COUNT(*) FROM `forum_answers` WHERE answerid = '$display[0]'");

                echo '
                <a href="/php/forum_answer.php?id=' . $display[0] . '">
                    <div class="libitem" class="unhover">

                        <div class="libicon">
                            <img style="border-radius: 50%" src="' . $requestavatar[0][0] . '" alt="">
                        </div>
