...
<body>
    ...
    <div id="content" class="content">
        ...
        <div class="main">
            ...
            $favinfo = mysqli_query($connect, "SELECT * FROM `favorite` JOIN `programs` ON `item_id` = `programs`.`id` WHERE `userid` = '$userid'");
            // $favinfo = mysqli_fetch_all(mysqli_query($connect, "SELECT * FROM `favorite` JOIN `programs` ON `item_id` = `programs`.`id` WHERE `userid` = '$userid'"));
            
            // $results = mysqli_fetch_all(mysqli_query($connect, "SELECT * FROM `favorite` WHERE `userid` = '$userid'"));
            // $iteminfo = mysqli_fetch_all(mysqli_query($connect, "SELECT * FROM `programs` WHERE `id` = '$result[1]'"));
            
            while ($fav = $favinfo->fetch_assoc()) {

                echo '

                <a href="/php/itempage.php?id=' . $fav["id"] . '">
                    <div class="libitem">
                        ...
                        <a class="linkfavdel" href="/code/delfav.php?item_id=' . $fav["id"] . '">
                            <div class="delfav">
                                <p>Удалить</p>
                            </div>
                        </a>
