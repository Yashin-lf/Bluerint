...
if ($_COOKIE['loged'] == ''):
    ...
    if (isset($_GET['delete'])) {
        $acc =$_GET['delete'];
        $delacc = mysqli_query($connect, "DELETE FROM `accounts` WHERE `id` = '$acc'");
    }
        ...
        <div id="content" class="content">
            ...
            <div class="main">
                ...
                <div class="products">
                    ...
                    $result = mysqli_fetch_all(mysqli_query($connect, "SELECT `id`,`login`,`mail`,`balance`,`avatar` FROM `accounts`"));
                    foreach ($result as $item) {
                        ...
                        <p style="padding-top:10px; font-weight: 600">'.$item[2].'</p>
                        <p style="padding-top:10px; font-weight: 600">'.$item[1].'</p>
                        <p style="padding-top:10px; font-weight: 600; font-family: '.'Outfit'.', sans-serif;">'.$item[3].'</p>

                        <a href="users.php?delete='.$item[0].'">
                            <div class="edititem">
                                <p>Удалить</p>
                            </div>
                        </a>
