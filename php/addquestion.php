...
<body>
    ...
    <div id="content" class="content">
        ...
        <div class="main">
            ...
            <div class="question">
                <form action="/code/addtoforum.php" method="post">
                    <input class="head" name="header" type="text" placeholder="Введите суть вопроса">
                    <textarea class="text" name="text" type="text"
                        placeholder="Введите вопрос, опишите его подробно чтобы знатаки поняли вас и дали ответ)"></textarea>
                    <input name="userid" type="hidden" value="<?= $userid ?>">
                    <input name="userlogin" type="hidden" value="<?= $userlogin ?>">
                    <button class="gogo" type="submit">Отправить</button>
                </form>
