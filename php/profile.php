    ...
    <div id="content" class="content">
        ...
        <div class="main">
            ...
            <div class="accc">
                ...
                <div class="avatarka" style="background: url(<?=$useravatar?>); background-size: 100%;">
                ...
                if ($userrole == 1) {
                    echo'<a href="/php/adminpanel.php">
                    <div class="adminka">
            ...
            <div class="settings">
                ...
                <form action="/code/update.php" method="post" enctype="multipart/form-data">

                <p>Ваше имя</p>
                <input name="name" type="text" value="<?=$username?>">

                <p>Ваш аватар</p>
                <input name="avatar" style="padding-top: 13px; height: 37px" type="file">

                <p>Ваш e-mail</p>
                <input name="mail" type="text" value="<?=$usermail?>">

                <br>
                <button class="hov" type="submit">Сохранить изменения</button>

                </form>

                <h2>Безопасность</h2>

                <form action="/code/updatepass.php" method="post">
                <p>Новый пароль</p>
