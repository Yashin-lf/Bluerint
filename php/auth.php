...
<body>
        ...
        <div class="infoform">
            ...
            <div class="selectauth">
                <a href="/php/auth.php">
                    <h3 style="color: #2C2C2C;">Авторизация</h3>
                </a>
                <a href="/php/registration.php">
                    <h3 style="color: #666666; margin-left: 40px">Регистрация</h3>
                </a>
            </div>

            <form action="/code/authcode.php" method="post" enctype="multipart/form-data">
                <input name="login" style="margin-top: 40px" type="text" placeholder="Логин">
                <input name="password" type="password" placeholder="Пароль">

                <?php

                    if($_SESSION['goodalert']) {

                        echo '
                        <div class="goodalert">
                            <p>'. $_SESSION['goodalert'] .'</p>
                        </div>
                        ';
                    }

                    unset ($_SESSION['goodalert']);
