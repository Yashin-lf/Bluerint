        ...
        <div class="main">
            ...
            <div class="aboutitem">
                <div class="selectinfo">
                    ...
                    if ($category == 3) {
                        ...
                        echo '<h4 id="minbtn">Мин. Требования</h4>';
                    }
            ...
            <div class="itemright">
                ...
                if ($_COOKIE['loged'] == ''):
                    ...
                    $requre = mysqli_fetch_assoc(mysqli_query($connect, "SELECT * FROM `favorite` WHERE `userid` = '$userid' AND `item_id` = '$item_id'"));
                    if (isset($requre)) {
                        echo '
                    <a href="/code/delfav.php?item_id=' . $item_id . '">
                    <div class="favbtn est">
                    ...
                    ';
                        ...
                        echo '
                    <a href="/code/addfav.php?item_id=' . $item_id . '">
                    <div class="favbtn">
                ...
                <div class="genremore">
                    ...
                    foreach ($samegenres as $samegenre) {
                        echo '<a style="color: #2C2C2C" href="/php/itempagePrograms.php?id=' . $samegenre[0] . '">
                                <div class="genreitem">
