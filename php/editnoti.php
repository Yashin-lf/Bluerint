...
if (isset($_GET['delete'])) {
    $delete = mysqli_query($connect, "DELETE FROM `notifications` WHERE `id` = '$article_id'");
    header('Location: ../php/editnoti.php');
}
    ...
    <div id="content" class="content">
        ...
        <div class="main">
            ...
            <div class="mainprogs">
                ...
                <form action="/code/addnoti.php" method="post" enctype="multipart/form-data"><br>
                    <input name="name" type="text" placeholder="Заголовок новости"><br>
                    <textarea name="text" id="" cols="30" rows="10" placeholder="Текст новости"></textarea><br>
                ...
                $items = mysqli_query($connect, "SELECT * FROM `notifications`");
                $items = mysqli_fetch_all($items);

                foreach ($items as $item) {
                    echo '<div class="noti">

                        <a href="editnoti.php?delete='.$item[0].'">
                            <div class="deletenoti">
                                <p>Удалить</p>
                            </div>
                        </a>
