...
<head>
    ...
    <link rel="stylesheet" href="/css/forum_answers.css">
...
<body>
    ...
    <div id="content" class="content">
        ...
        <div class="navigation">
            ...
            <div class="menu">
                ...
                <a href="/php/forum.php">
                    <div style="background: #F24747; box-shadow: 0px 0px 20px 5px rgba(0, 0, 0, 0.199);" class="mbtn">

                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0_226_368)">
                                <path style="fill: #EFEFEF; stroke: #EFEFEF;"
        ...
        <div class="main">
            ...
            $forum = mysqli_query($connect, "SELECT * FROM `forum` WHERE id = $question_id");
            ...
            <?php
            if ($_COOKIE['loged'] == ''):
                echo '<h3 class="inform">Авторизуйтесь, чтобы писать ответы</h3>
                ';
            else:
                ?>
                <form class="send_form" action="../code/writeanswer.php" method="post">
                    <input name="text" id="" placeholder="Ваш комментарий" maxlength="250"></input>
                    <input name="userid" type="hidden" value="<?= $userid ?>">
                    <input name="answerid" type="hidden" value="<?= $question_id ?>">
            ...
            <div class="answers">
                <?php
                $answers = mysqli_query($connect, "SELECT * FROM `forum_answers` JOIN `accounts` ON `userid` = `accounts`.`id` WHERE `answerid` = $question_id ORDER BY `forum_answers`.`date` DESC");
