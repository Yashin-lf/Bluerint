    ...
    <div id="content" class="content">
            ...
            <div class="menu">
                ...
                <a href="/php/library.php">
                    <div style="background: #F24747; box-shadow: 0px 0px 20px 5px rgba(0, 0, 0, 0.199);" class="mbtn">
                        ...
                        <p style="color: white">Библиотека</p>
        ...
        <div class="main">
            ...
            if ($_COOKIE['loged'] == ''):
                ...
                echo '<p style="color: #2C2C2C; padding-top: 20px"><a style="color: #2C2C2C" href="/php/auth.php">Авторизуйтесь</a>, чтобы видеть свою библиотеку</p>';
            else:


                $basketinfo = mysqli_query($connect, "SELECT * FROM `library` JOIN `programs` ON `itemid` = `programs`.`id` WHERE `userid` = '$userid'");
                ...
                while ($basket = $basketinfo->fetch_assoc()) {
                    ...
                    <div style="margin-top: 33px" class="iteminfo">
                        <h4>' . $basket["name"] . '</h4>
                        <p>' . $basket["minsize"] . ' GB</p>
                    </div>

                    <a download="" href="' . $basket["download"] . '">
