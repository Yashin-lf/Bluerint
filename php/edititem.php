...
<body>
    ...
    <div id="content" class="content">
        ...
        <div class="main">
            ...
            <?php
            $item_id = $_GET['id'];
            $result = mysqli_fetch_all(mysqli_query($connect, "SELECT * FROM `programs` WHERE `id` = '$item_id'"))

            ?>

            <form class="editform" action="/code/editcode.php" method="post">
                <input type="hidden" name="id" id="" value="<?=$result[0][0]?>">
                <p style="margin-bottom: 5px">Название</p>
                <input type="text" name="name" id="" value="<?=$result[0][1]?>">

                <p style="margin-bottom: 5px">Цена</p>
                <input type="text" name="price" id="" value="<?=$result[0][2]?>">

                <p style="margin-bottom: 5px">Жанр</p>
                <input type="text" name="genre" id="" value="<?=$result[0][3]?>">

                <p style="margin-bottom: 5px">Разработчик</p>
                <input type="text" name="developer" id="" value="<?=$result[0][4]?>">

                <p style="margin-bottom: 5px">Версия</p>
                <input type="text" name="version" id="" value="<?=$result[0][5]?>">

                <p style="margin-bottom: 5px">Система</p>
                <input type="text" name="system" id="" value="<?=$result[0][6]?>">

                <p style="margin-bottom: 5px">Архетиктура</p>
                <input type="text" name="architecture" id="" value="<?=$result[0][7]?>">

                <p style="margin-bottom: 5px">Дата выхода</p>
                <input type="text" name="date" id="" value="<?=$result[0][8]?>">

                <p style="margin-bottom: 5px">Подробости</p>
                <input type="text" name="about" id="" value="<?=$result[0][9]?>">

                <p style="margin-bottom: 5px">Мин. Процессор</p>
                <input type="text" name="mincpu" id="" value="<?=$result[0][11]?>">

                <p style="margin-bottom: 5px">Мин. ОЗУ</p>
                <input type="text" name="minram" id="" value="<?=$result[0][12]?>">

                <p style="margin-bottom: 5px">Мин. Видеокарта</p>
                <input type="text" name="mingpu" id="" value="<?=$result[0][13]?>">

                <p style="margin-bottom: 5px">Мин. Место на диске</p>
                <input type="text" name="minsize" id="" value="<?=$result[0][14]?>">

                <button>Сохранить</button>

                <a href="/code/editcode.php?delete=<?=$item_id?>">
                    <div class="delitem">
                        <p>Удалить продукт</p>
                    </div>
                </a>
...
<script>
    ...
    let timerId = setInterval(() => ban2(), 8000);
    let timerId2 = setInterval(() => ban1(), 16000);
</script>
