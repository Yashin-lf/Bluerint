        ...
        <div id="content" class="content">
            ...
            <div class="main">
                ...
                <div class="products">
                    ...
                    $result = mysqli_fetch_all(mysqli_query($connect, "SELECT `id`,`name`,`price`,`genre`,`icon` FROM `programs`"));
                    foreach ($result as $item) {
                        ...
                        <p style="padding-top:10px; font-weight: 600">'.$item[3].'</p>
                        <p style="padding-top:10px; font-weight: 600">'.$item[2].'</p>

                        <a href="edititem.php?id='.$item[0].'">
                            <div class="edititem">
                                <p>Изменить</p>
                            </div>
                        </a>
...
<!-- 
                <div class="selectcont">
                    ...
                    <a href="">
                        <div style="border-radius: 0px 5px 5px 0px" class="selcon">
                            <h3>Плагинов</h3>
                        </div>
                    </a>
