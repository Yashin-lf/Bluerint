...
$item_id = $_GET['id'];
$programinfo = mysqli_query($connect, "SELECT * FROM `programs`");
$program = mysqli_fetch_all($programinfo);


$iteminfo = mysqli_query($connect, "SELECT * FROM `plugins` WHERE `id`= '$item_id'");
    ...
    <div id="content" class="content">
        ...
        <div class="main">
            ...
            <div class="itemright">
                ...
                <p class="genremorep">Относится к программе</p>
                ...
                <div class="genremore">
                    ...
                    $mainprogram = mysqli_query($connect, "SELECT * FROM `programs` WHERE `programs`.`id` = $which_program LIMIT 1");
                    $main_programms = mysqli_fetch_all($mainprogram);

                    foreach ($main_programms as $main_programm) {
                        echo '<a style="color: #2C2C2C" href="/php/itempagePrograms.php?id=' . $main_programm[0] . '">
                                <div class="genreitem">
                                    <img src="' . $main_programm[16] . '" alt="">
                                    <h4>' . $main_programm[1] . '</h4>
                                </div>
                            </a>';
                    }
                ...
                <div class="genremore">
                    ...
                    $itemgenre = mysqli_query($connect, "SELECT * FROM `plugins` WHERE `program_id`= $which_program AND id != $item_id LIMIT 3");
                    $samegenres = mysqli_fetch_all($itemgenre);

                    foreach ($samegenres as $samegenre) {
                        echo '<a style="color: #2C2C2C" href="/php/itempagePlugins.php?id=' . $samegenre[0] . '">
                        <div class="genreitem">
