    ...
    <div id="content" class="content">
        ...
        <div class="main">
            ...
            <div class="banner">
                ...
                <div id="bannerone" class="banitem">

                    <div class="bantext">

                        <img src="/image/blend.png" id="blend" alt="">

                        <p>Создай свою реальность</p>
                        <h3>Скачай и установи лучший 3D редактор <br>по мнению пользователей BluePrint.</h3>

                        <a href="/php/itempage.php?id=22">
                            <div class="blendlink">
                                <p>Скачать</p>
                            </div>
                        </a>
                ...
                <div id="bannertwo" class="banitem2">

                    <div class="bantext2">

                        <h2>NVIDIA RTX Voice</h2>

                        <p>Плагин для обработки голоса</p>
                        <h3>Обрабатывай свой голос в режиме реального времени<br>
                            </h3>

                        <a href="/php/itempage.php?id=23">
                            <div class="winlink">
                                <p>Купить</p>
                            </div>
                        </a>
            ...
            <div class="mainprogs">
                ...
                <a href="php/programs.php" class="watchall">
                    <p>Смотреть все</p>
                </a>
                ...
                <div class="progsetka">
                    ...
                    <?php
                    $programs = mysqli_query($connect, "SELECT * FROM `programs` WHERE `programs`.`category` = '2'  ORDER BY `programs`.`rating` DESC LIMIT 8");
                    $programs = mysqli_fetch_all($programs);
                    foreach ($programs as $program) {
                        echo '
                        <a href="php/itempage.php?id=' . $program[0] . '"><div class="progsetkaitem">

                        <img src="' . $program[16] . '" alt="">
                        <h4>' . $program[1] . '</h4>
                        <p>' . $program[3] . '</p>
                    </div></a>
                        ';
            ...
            <div class="mainprogs">
                ...
                <a href="php/games.php" class="watchall">
                    <p>Смотреть все</p>
                </a>
                ...
                <div class="gamesetka">
                    ...
                    <?php
                    $games = mysqli_query($connect, "SELECT * FROM `programs` WHERE `programs`.`category` = '1'  ORDER BY `programs`.`rating` DESC LIMIT 8");
                    $games = mysqli_fetch_all($games);
                    foreach ($games as $game) {
                        echo '
                        <a href="php/itempage.php?id=' . $game[0] . '">
            ...
            <div class="mainprogs">
                ...
                <a href="php/plugins.php" class="watchall">
                    <p>Смотреть все</p>
                </a>
                ...
                <div class="gamesetka">
                    ...
                    <?php
                    $plugins = mysqli_query($connect, "SELECT * FROM `programs` WHERE `programs`.`category` = '3'  ORDER BY `programs`.`rating` DESC LIMIT 8");
                    $plugins = mysqli_fetch_all($plugins);
                    foreach ($plugins as $plugin) {
                        echo ' <a href="php/itempage.php?id=' . $plugin[0] . '">
                        <div class="gamesetkaitem">

                            <img src="' . $plugin[18] . '" alt="">
            ...
            <div class="mainprogs">
                ...
                <?php
                    ...
                    $items = mysqli_query($connect, "SELECT * FROM `articles` ORDER BY `articles`.`id` DESC LIMIT 8");
